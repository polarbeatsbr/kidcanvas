...
// --- MÓDULO DOS MASCOTES AUXILIARES (DESATIVADO/HIDDEN) ---
...
function triggerMascotSpeak(context, customText = null) {
    ...
    const fullContainer = document.getElementById('mascot-full-container');
    const casinhaContainer = document.getElementById('mascot-casinha-container');

    if (helper) helper.style.setProperty('display', 'none', 'important');
    if (casinha) casinha.style.setProperty('display', 'none', 'important');
    if (fullContainer) fullContainer.style.setProperty('display', 'none', 'important');
    if (casinhaContainer) casinhaContainer.style.setProperty('display', 'none', 'important');
    return;
}
...
function updatePaintCursor(tool, stamp) {
    ...
    if (tool === 'bucket') {
        paintCanvas.style.cursor = 'url("data:image/svg+xml;utf8,<svg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 576 512\' width=\'32\' height=\'32\' fill=\'black\'><path d=\'M41.4 9.4C53.9-3.1 74.1-3.1 86.6 9.4L168 90.7l53.1-53.1c28.1-28.1 73.7-28.1 101.8 0L474.3 189.1c28.1 28.1 28.1 73.7 0 101.8L283.9 481.4c-37.5 37.5-98.3 37.5-135.8 0L30.6 363.9c-37.5-37.5-37.5-98.3 0-135.8L122.7 136 41.4 54.6c-12.5-12.5-12.5-32.8 0-45.3zm176 221.3L168 181.3 75.9 273.4c-4.2 4.2-7 9.3-8.4 14.6H386.7l42.3-42.3c3.1-3.1 3.1-8.2 0-11.3L277.7 82.9c-3.1-3.1-8.2-3.1-11.3 0L213.3 136l49.4 49.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0zM512 512c-35.3 0-64-28.7-64-64c0-25.2 32.6-79.6 51.2-108.7c6-9.4 19.5-9.4 25.5 0C543.4 368.4 576 422.8 576 448c0 35.3-28.7 64-64 64z\'/></svg>") 28 28, auto';
...
const stickerCategories = {
    ...
    orelhas: [
        ...
        { name: "Orelhas de Coelho", url: "/stickers/orelhas/ear_003.png" },
        { name: "Orelhas de Panda", url: "/stickers/orelhas/ear_004.png" },
        { name: "Orelhas de Tigre", url: "/stickers/orelhas/ear_005.png" },
        { name: "Orelhas de Leão", url: "/stickers/orelhas/ear_006.png" },
        { name: "Orelhas de Raposa", url: "/stickers/orelhas/ear_007.png" },
        { name: "Orelhas de Lobo", url: "/stickers/orelhas/ear_008.png" },
        { name: "Orelhas de Urso", url: "/stickers/orelhas/ear_009.png" },
        { name: "Espinhos de Dinossauro", url: "/stickers/orelhas/ear_010.png" },
        { name: "Chifres de Dragão", url: "/stickers/orelhas/ear_011.png" },
        { name: "Chifre de Unicórnio", url: "/stickers/orelhas/ear_012.png" },
        { name: "Orelhas de Vaca", url: "/stickers/orelhas/ear_013.png" },
        { name: "Orelhas de Cavalo", url: "/stickers/orelhas/ear_014.png" },
        { name: "Orelhas de Porco", url: "/stickers/orelhas/ear_015.png" },
        { name: "Orelhas de Macaco", url: "/stickers/orelhas/ear_016.png" },
        { name: "Orelhas de Girafa", url: "/stickers/orelhas/ear_017.png" },
        { name: "Orelhas de Zebra", url: "/stickers/orelhas/ear_018.png" },
        { name: "Orelhas de Elefante", url: "/stickers/orelhas/ear_019.png" },
        { name: "Orelhas de Hipopótamo", url: "/stickers/orelhas/ear_020.png" },
        { name: "Antenas de Alien", url: "/stickers/orelhas/ear_021.png" },
        { name: "Orelhas de Robô", url: "/stickers/orelhas/ear_022.png" },
        { name: "Orelhas de Morcego", url: "/stickers/orelhas/ear_023.png" },
        { name: "Penas de Coruja", url: "/stickers/orelhas/ear_024.png" },
        { name: "Orelhas de Pinguim", url: "/stickers/orelhas/ear_025.png" },
        { name: "Olhos de Sapo", url: "/stickers/orelhas/ear_026.png" },
        { name: "Espinhos de Jacaré", url: "/stickers/orelhas/ear_027.png" },
        { name: "Barbatana de Tubarão", url: "/stickers/orelhas/ear_028.png" },
        { name: "Tentáculos de Polvo", url: "/stickers/orelhas/ear_029.png" },
        { name: "Antenas de Abelha", url: "/stickers/orelhas/ear_030.png" },
        { name: "Antenas de Joaninha", url: "/stickers/orelhas/ear_031.png" },
        { name: "Antenas de Borboleta", url: "/stickers/orelhas/ear_032.png" },
        { name: "Chifres de Rena", url: "/stickers/orelhas/ear_033.png" },
        { name: "Chifres de Cervo", url: "/stickers/orelhas/ear_034.png" },
        { name: "Chifres de Alce", url: "/stickers/orelhas/ear_035.png" },
        { name: "Chifrinhos de Diabinho", url: "/stickers/orelhas/ear_036.png" },
        { name: "Auréola de Anjinho", url: "/stickers/orelhas/ear_037.png" },
        { name: "Orelhas de Elfo", url: "/stickers/orelhas/ear_038.png" },
        { name: "Orelhas de Duende", url: "/stickers/orelhas/ear_039.png" },
        { name: "Orelhas de Fada", url: "/stickers/orelhas/ear_040.png" },
        { name: "Orelhas do Pikachu (Soltas)", url: "/stickers/orelhas/ear_041.png" },
        { name: "Orelhas de Ogro (Shrek)", url: "/stickers/orelhas/ear_042.png" },
        { name: "Orelhas de Alien (Stitch)", url: "/stickers/orelhas/ear_043.png" },
        { name: "Orelhas do Mickey (Soltas)", url: "/stickers/orelhas/ear_044.png" },
        { name: "Orelhas da Minnie (Soltas)", url: "/stickers/orelhas/ear_045.png" },
        { name: "Orelhas do Sonic (Soltas)", url: "/stickers/orelhas/ear_046.png" },
        { name: "Orelhas de Dálmata (Soltas)", url: "/stickers/orelhas/ear_047.png" },
        { name: "Orelhas de Coala (Soltas)", url: "/stickers/orelhas/ear_048.png" },
        { name: "Orelhas de Canguru (Soltas)", url: "/stickers/orelhas/ear_049.png" },
        { name: "Orelhas de Ovelha (Soltas)", url: "/stickers/orelhas/ear_050.png" },
        { name: "Orelhas de Urso Polar (Soltas)", url: "/stickers/orelhas/ear_051.png" },
        { name: "Orelhas de Panda Vermelho (Soltas)", url: "/stickers/orelhas/ear_052.png" },
        { name: "Orelhas de Leopardo (Soltas)", url: "/stickers/orelhas/ear_053.png" },
        { name: "Orelhas de Guaxinim (Soltas)", url: "/stickers/orelhas/ear_054.png" },
        { name: "Orelhas de Esquilo (Soltas)", url: "/stickers/orelhas/ear_055.png" },
        { name: "Orelhas de Burrinho (Soltas)", url: "/stickers/orelhas/ear_056.png" },
        { name: "Orelhas de Raposa Mística (Soltas)", url: "/stickers/orelhas/ear_057.png" },
        { name: "Orelhas de Pantera Negra (Soltas)", url: "/stickers/orelhas/ear_058.png" },
        { name: "Orelhas de Hiena (Soltas)", url: "/stickers/orelhas/ear_059.png" },
        { name: "Orelhas e Chifres de Dragão (Soltos)", url: "/stickers/orelhas/ear_060.png" },
        { name: "Orelhas de Morcego Lilás (Soltas)", url: "/stickers/orelhas/ear_061.png" },
        { name: "Orelhas e Chifres de Cervo (Soltos)", url: "/stickers/orelhas/ear_062.png" },
        { name: "Orelhas de Tigre Branco (Soltas)", url: "/stickers/orelhas/ear_063.png" },
        { name: "Orelhas de Gato Branco (Soltas)", url: "/stickers/orelhas/ear_064.png" },
        { name: "Orelhas de Golden Retriever (Soltas)", url: "/stickers/orelhas/ear_065.png" },
        { name: "Orelhas de Coelho Caídas (Soltas)", url: "/stickers/orelhas/ear_066.png" },
        { name: "Orelhas e Antena de Alien (Soltos)", url: "/stickers/orelhas/ear_067.png" },
        { name: "Orelhas de Pegasus (Soltas)", url: "/stickers/orelhas/ear_068.png" },
        { name: "Orelhas de Elfo (Soltas)", url: "/stickers/orelhas/ear_069.png" },
        { name: "Orelhas de Fada Borboleta (Soltas)", url: "/stickers/orelhas/ear_070.png" },
        { name: "Orelhas de Gato Preto (Soltas)", url: "/stickers/orelhas/ear_071.png" },
        { name: "Orelhas e Galhos de Rena (Soltos)", url: "/stickers/orelhas/ear_072.png" },
        { name: "Orelhas de Puma (Soltas)", url: "/stickers/orelhas/ear_073.png" },
        { name: "Orelhas de Guepardo (Soltas)", url: "/stickers/orelhas/ear_074.png" },
        { name: "Orelhas de Lontra (Soltas)", url: "/stickers/orelhas/ear_075.png" },
        { name: "Orelhas de Castor (Soltas)", url: "/stickers/orelhas/ear_076.png" },
        { name: "Orelhas de Texugo (Soltas)", url: "/stickers/orelhas/ear_077.png" },
        { name: "Orelhas de Raposa do Ártico (Soltas)", url: "/stickers/orelhas/ear_078.png" },
        { name: "Orelhas de Fênix (Soltas)", url: "/stickers/orelhas/ear_079.png" },
        { name: "Orelhas de Grifo (Soltas)", url: "/stickers/orelhas/ear_080.png" },
        { name: "Orelhas de Gato (Preto/Rosa - Ref)", url: "/stickers/orelhas/ear_081.png" },
        { name: "Orelhas de Cachorro (Ref)", url: "/stickers/orelhas/ear_082.png" },
        { name: "Orelhas de Coelho (Ref)", url: "/stickers/orelhas/ear_083.png" },
        { name: "Orelhas de Panda (Ref)", url: "/stickers/orelhas/ear_084.png" },
        { name: "Orelhas de Tigre (Ref)", url: "/stickers/orelhas/ear_085.png" },
        { name: "Orelhas de Raposa (Ref)", url: "/stickers/orelhas/ear_086.png" },
        { name: "Orelhas de Lobo (Ref)", url: "/stickers/orelhas/ear_087.png" },
        { name: "Orelhas de Urso (Ref)", url: "/stickers/orelhas/ear_088.png" },
        { name: "Orelhas de Porco (Ref)", url: "/stickers/orelhas/ear_089.png" },
        { name: "Orelhas/Chifres de Girafa (Ref)", url: "/stickers/orelhas/ear_090.png" },
        { name: "Orelhas de Zebra (Ref)", url: "/stickers/orelhas/ear_091.png" },
        { name: "Orelhas de Elefante (Ref)", url: "/stickers/orelhas/ear_092.png" },
        { name: "Orelhas de Coala (Ref)", url: "/stickers/orelhas/ear_093.png" },
        { name: "Orelhas de Leão (Ref)", url: "/stickers/orelhas/ear_094.png" },
        { name: "Orelhas de Leopardo (Ref)", url: "/stickers/orelhas/ear_095.png" },
        { name: "Orelhas/Chifres de Vaca (Ref)", url: "/stickers/orelhas/ear_096.png" },
        { name: "Orelhas de Porco (Em Pé - Ref)", url: "/stickers/orelhas/ear_097.png" },
        { name: "Orelhas de Macaco (Ref)", url: "/stickers/orelhas/ear_098.png" },
        { name: "Olhos de Sapo (Ref)", url: "/stickers/orelhas/ear_099.png" },
        { name: "Orelhas de Jacaré / Monstro (Ref)", url: "/stickers/orelhas/ear_100.png" },
        { name: "Orelhas de Alien (Azul - Ref)", url: "/stickers/orelhas/ear_101.png" },
        { name: "Chifres de Dragão (Laranja - Ref)", url: "/stickers/orelhas/ear_102.png" },
        { name: "Chifres de Unicórnio (Ref)", url: "/stickers/orelhas/ear_103.png" },
        { name: "Orelhas de Gato (Bege/Rosa - Ref)", url: "/stickers/orelhas/ear_104.png" },
        { name: "Chifres e Orelhas de Cervo (Ref)", url: "/stickers/orelhas/ear_105.png" },
        { name: "Chifres de Alce (Ref)", url: "/stickers/orelhas/ear_106.png" },
        { name: "Chifres de Rena (Ref)", url: "/stickers/orelhas/ear_107.png" },
        { name: "Auréola/Asas de Anjo (Ref)", url: "/stickers/orelhas/ear_108.png" },
        { name: "Chifres de Diabinho (Ref)", url: "/stickers/orelhas/ear_109.png" },
        { name: "Asas de Morcego (Ref)", url: "/stickers/orelhas/ear_110.png" },
        { name: "Asas de Dragão / Vampiro (Ref)", url: "/stickers/orelhas/ear_111.png" },
        { name: "Asas de Fada (Ref)", url: "/stickers/orelhas/ear_112.png" },
        { name: "Orelhas de Elfo (Ref)", url: "/stickers/orelhas/ear_113.png" },
        { name: "Orelhas de Duende (Ref)", url: "/stickers/orelhas/ear_114.png" },
        { name: "Orelhas do Pikachu (Ref)", url: "/stickers/orelhas/ear_115.png" },
        { name: "Orelhas de Robô (Ref)", url: "/stickers/orelhas/ear_116.png" },
        { name: "Antenas de Alien (Ref)", url: "/stickers/orelhas/ear_117.png" },
        { name: "Antenas de Borboleta (Roxa - Ref)", url: "/stickers/orelhas/ear_118.png" },
        { name: "Antenas de Abelha (Ref)", url: "/stickers/orelhas/ear_119.png" },
        { name: "Asas de Borboleta (Ref)", url: "/stickers/orelhas/ear_120.png" }
    ],
    top: ['😎', '👑', '🌈', '⭐', '❤️', '🎈', '🦋', '🐶', '🐱', '☀️', '🌙', '🚀', '🏆'],
    animais: ['🦁', '🐯', '🐱', '🐶', '🐰', '🦊', '🐻', '🐼', '🐨', '🐵', '🐸', '🐹', '🐧', '🐥', '🐝', '🐞', '🦋'],
    dinossauros: ['🦖', '🦕', '🐊', '🐢', '🦎', '🐍', '🐲', '🐉', '🥚'],
...
function switchStickerTab(tab) {
    ...
    if (container) {
        ...
        const tabNames = ['top', 'animais', 'dinossauros', 'natureza', 'festa', 'espaco', 'fantasia', 'acessorios', 'chapeus', 'orelhas', 'desbloqueaveis'];
...
window.openAlbumModal = async function() {
    ...
    try {
        ...
        console.error('[openAlbumModal rendering error]', err);
    }
};
